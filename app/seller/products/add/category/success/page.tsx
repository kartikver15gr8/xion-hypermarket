...
export default function page() {
  const tweetText =
    "Check Sendit, a marketplace for all digital creators to sell and earn";
  const tweetUrl = "https://sendit.markets";
  ...
  return (
    <div className="pt-16 pb-20 sm:px-[20px] md:px-[40px] lg:px-[60px] xl:px-[150px] 2xl:px-[200px] min-h-screen bg-[#FAF9F5] w-full relative overflow-y-auto hide-scrollbar h-[90vh] scroll-smooth ">
        ...
        <div className="relative z-20 w-full h-full flex flex-col items-center justify-center ">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-slate-400">
              Your product is now listed and ready to find its new owner.
            </p>
            <p className="text-sm text-slate-400">
          ...
          <div className="flex flex-col items-center justify-center ">
            ...
            <div onClick={handleTweet} className="flex gap-x-2">
