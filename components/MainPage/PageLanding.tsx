...
function PageLandingContent() {
  ...
  return (
    <div className="pt-16 relative flex px-5 sm:px-8 lg:px-10 xl:px-24 h-[500px] justify-center md:h-[570px] lg:h-[600px] -black overflow-hidden">
      <Image src={bannerdd} alt="Background" layout="fill" objectFit="cover" />

      {/* <Image
        src={figma}
        className="absolute hidden lg:flex w-[50px] left-0 sm:left-5 md:left-[5%] lg:left-[7%] xl:left-[9%] sm:w-[130px] md:w-[140px] lg:w-[160px] xl:w-[120px] -rotate-6 top-28 h-fit"
        alt="figma"
      />

      <Image
        src={tele}
        className="absolute hidden lg:flex w-[60px] left-0 sm:left-5 md:left-[10%] lg:left-[13%] xl:left-[15%]  sm:w-[120px] md:w-[130px] lg:w-[140px] xl:w-[150px] -rotate-6 bottom-20 h-fit"
        alt="shopify"
      />
      <Image
        src={chatgpt}
        className="absolute hidden lg:flex w-[50px] left-0 sm:left-5 md:left-[10%] lg:left-[13%] xl:-left-5 sm:w-[120px] md:w-[130px] lg:w-[140px] xl:w-[90px] -rotate-6 bottom-52 h-fit"
        alt="shopify"
      />

      <Image
        src={capsule}
        className="absolute hidden lg:flex w-[40px] right-0 sm:right-5 md:right-[10%] lg:right-[13%] xl:left-[25%]  sm:w-[110px] md:w-[125px] lg:w-[130px] xl:w-[65px] -rotate-6 bottom-[50%] h-fit"
        alt="x"
      /> */}
      ...
      <div className="w-full flex flex-col z-10 ">
        <div className="relative mt-28">
          <p className="text-4xl md:text-5xl xl:text-6xl text-white font-bold italic mt-8 xl:mt-14">
            Start Your
          </p>
